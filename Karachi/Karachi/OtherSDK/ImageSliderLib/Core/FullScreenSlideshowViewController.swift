...
open class FullScreenSlideshowViewController: UIViewController {
    ...
    override open func viewDidLoad() {
        ...
        let vX = view.frame.maxX - 40
        closeButton.frame = CGRect(x: vX, y: 20, width: 40, height: 40)
        closeButton.setImage( #imageLiteral(resourceName: "ic_cross_white.png"), for: UIControlState())
